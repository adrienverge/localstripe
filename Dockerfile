...
CMD ["ddtrace-run", "gunicorn", "--workers", "24", "--bind", "0.0.0.0:8420", "--worker-class", "aiohttp.GunicornWebWorker", "localstripe.server:app", "--access-logfile", "-", "--error-logfile", "-", "--log-file", "-"]
